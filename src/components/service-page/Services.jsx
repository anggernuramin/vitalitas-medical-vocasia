    ...
    <div className="container mx-auto mt-24 min-w-full">
      <section className="flex justify-center items-center flex-col gap-5">
        ...
        <div className="justify-center items-center flex-col w-64 py-5 px-5 rounded-sm border-slate-500">
            ...
            <p className="text-base mb-5">Kami melayani dengan sepenuh hati untuk kepuasan pasien.</p>
          </div>
          <div className="border flex justify-center items-center flex-col w-64 py-5 px-5 rounded-sm border-slate-500">
            ...
            <p className="text-center">Konsultasikan keluhan gigi anda kepada kami.</p>
          </div>
          <div className="border flex justify-center items-center flex-col w-64 py-5 px-5 rounded-sm border-slate-500">
            <span className="mb-5">
            ...
            <p className="text-center">Kami melayani berbagai perawatan gigi untuk menjadikan gigi tetap sehat.</p>
          </div>
          <div className="border flex justify-center items-center flex-col w-60 py-5 px-5 rounded-sm border-slate-500">
            ...
            <p className="text-center"> Klinik kami menyediakan berbagai layanan untuk anda.</p>
          </div>
        </div>
      </section>
      <br></br>
