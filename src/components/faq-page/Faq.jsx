    ...
    <>
      ...
      <div className="container center">
        ...
        <div className="collapse collapse-plus bg-base-200 mb-2">
          ...
          <div className="collapse-content">
            <p>
              ...
              plak dan tartar yang dapat menyebabkan masalah gigi dan gusi. Ini
              juga mendukung pemeliharaan kesehatan mulut secara keseluruhan.
            </p>
          </div>
        </div>
        <div className="collapse collapse-plus bg-base-200 mb-2">
        ...
        <div className="collapse collapse-plus bg-base-200 mb-2">
          ...
          <div className="collapse-content">
            <p>
              Sikat gigi setidaknya dua kali sehari, gunakan benang gigi secara
              teratur, batasi konsumsi gula, hindari rokok, dan hindari minuman
              berwarna yang dapat membuat gigi berubah warna.
            </p>
          </div>
        </div>
      </div>
